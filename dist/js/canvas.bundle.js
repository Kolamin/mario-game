...
/* eslint-disable */
(_console = console).log.apply(_console, _toConsumableArray(oo_oo("56a844c7_0", _img_platform_png__WEBPACK_IMPORTED_MODULE_0__["default"])));
...
function animate() {
  ...
  if (scrollOffset > 2000) {
    var _console2;
    /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("56a844c7_1", "you win")));
  }
}
animate();
addEventListener("keydown", function (_ref2) {
  var _console3, _console4, _console5, _console6;
  var keyCode = _ref2.keyCode;
  switch (keyCode) {
    case 65:
      /* eslint-disable */(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("56a844c7_2", "left")));
      keys.left.pressed = true;
      break;
    case 83:
      /* eslint-disable */(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("56a844c7_3", "down")));
      break;
    case 68:
      /* eslint-disable */(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("56a844c7_4", "right")));
      keys.right.pressed = true;
      break;
    case 87:
      /* eslint-disable */(_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("56a844c7_5", "up")));
      player.velocity.y -= 10;
      break;
  }
});
addEventListener("keyup", function (_ref3) {
  var _console7, _console8, _console9, _console10;
  var keyCode = _ref3.keyCode;
  switch (keyCode) {
    case 65:
      /* eslint-disable */(_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("56a844c7_6", "left")));
      keys.left.pressed = false;
      break;
    case 83:
      /* eslint-disable */(_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("56a844c7_7", "down")));
      break;
    case 68:
      /* eslint-disable */(_console9 = console).log.apply(_console9, _toConsumableArray(oo_oo("56a844c7_8", "right")));
      keys.right.pressed = false;
      break;
    case 87:
      /* eslint-disable */(_console10 = console).log.apply(_console10, _toConsumableArray(oo_oo("56a844c7_9", "up")));
      player.velocity.y -= 10;
      break;
  }
});
